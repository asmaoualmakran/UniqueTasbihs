"""
Django settings for UnTas project.
...
# Function used by django to generate secret key, this makes sure it generates a new one 
# and is never known even though it's publisht on een public repo
